...
var Country = /** @class */ (function () {
    function Country(name, language, population, populationGrwothRate) {
        this.name = name;
...
var OICCountry = /** @class */ (function (_super) {
    ...
    function OICCountry(name, language, population, populationGrwothRate) {
        return _super.call(this, name, language, population, populationGrwothRate) || this;
    }
