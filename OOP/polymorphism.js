...
var Country = /** @class */ (function () {
    function Country(name, language, population, populationGrwothRate, _statePrivacey, _leader, religion) {
        this.planet = "Earth";
        this.name = name;
...
var OICCountry = /** @class */ (function (_super) {
    ...
    function OICCountry(name, language, population, populationGrwothRate, statePrivacy, leader, religion) {
        if (religion === void 0) { religion = "Islam"; }
        return _super.call(this, name, language, population, populationGrwothRate, statePrivacy, leader, religion) || this;
    }
...
var China = new Country("China", "Chineese", 5000000, 0, "Private Data", "China's Leader", "Buddism");
console.info(China);
